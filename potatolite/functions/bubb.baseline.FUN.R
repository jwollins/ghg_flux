...
bubbFUN <- function(dat) {
  ...
  dat$block <- ifelse(dat$Sample == "3B" | 
                        dat$Sample == "12B" | 
                        dat$Sample == "10A", 1, NA)
  
  dat$block <- ifelse(dat$Sample == "2B" | 
                        dat$Sample == "9B" | 
                        dat$Sample == "11A", 2, dat$block)
  
  dat$block <- ifelse(dat$Sample == "7A" | 
                        dat$Sample == "12A" | 
                        dat$Sample == "15A", 3, dat$block)
  
  dat$block <- ifelse(dat$Sample == "4A" | 
                        dat$Sample == "4B" | 
                        dat$Sample == "10B", 4, dat$block)
  
  dat$block <- ifelse(dat$Sample == "9BR" | 
                        dat$Sample == "16B" | 
                        dat$Sample == "1A", 5, dat$block)
  ...
  # add the block names to the df
  dat$timing <- ifelse(dat$Sample == "3B" | 
                         dat$Sample == "2B" | 
                         dat$Sample == "7A"| 
                         dat$Sample == "4A"| 
                        dat$Sample == "9BR", 20, NA)
  
  dat$timing <- ifelse(dat$Sample == "12B" | 
                         dat$Sample == "9B" | 
                         dat$Sample == "12A"| 
                         dat$Sample == "4B"| 
                         dat$Sample == "16B", 40, dat$timing)
  
  dat$timing <- ifelse(dat$Sample == "10A" | 
                         dat$Sample == "11A" | 
                         dat$Sample == "15A"| 
                         dat$Sample == "10B"| 
                         dat$Sample == "1A", 60, dat$timing)
