...
griffiths.postplant.FUN <- function(dat) {
  # rename cols
  names(dat) <- c(col.nam)
 ...
 # dat$day <- as.numeric(day)
  ...
  dat$Treatment <- ifelse(dat$Sample == "1-2-14" | 
                            ...
                            dat$Sample == "5-1-28"|
                            dat$Sample == "6-2-14"|
                            dat$Sample == "6-2-28", yes = "Conventional", no = NA)
  ...
  dat$Treatment <- ifelse(dat$Sample == "1-3-14" | 
                            ...
                            dat$Sample == "5-3-28"|
                            dat$Sample == "6-4-14"|
                            dat$Sample == "6-4-28", yes = "Fixed Tine Cover Crop", no = dat$Treatment)
  ...
  dat$Treatment <- ifelse(dat$Sample == "1-4-14" | 
                            ...
                            dat$Sample == "5-4-28"|
                            dat$Sample == "6-3-14"|
                            dat$Sample == "6-3-28", yes = "Strip Tillage", no = dat$Treatment)
  ...
  dat$Treatment <- ifelse(dat$Sample == "1-1-14" | 
                            ...
                            dat$Sample == "5-2-28"|
                            dat$Sample == "6-1-14"|
                            dat$Sample == "6-1-28", yes = "Fixed Tine No Cover Crop", no = dat$Treatment)
